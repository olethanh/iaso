...
type FormDataType = {
    id: { value: number | null; errors: string[] };
    name: { value: string; errors: string[] };
    short_name: { value: string; errors: string[] };
    depth: { value: number | null; errors: string[] };
    org_unit_type_ids: { value: number[]; errors: string[] };
    project_ids: { value: number[]; errors: string[] };
    period_type: {
        value: 'MONTH' | 'QUARTER' | 'SIX_MONTH' | 'YEAR' | null;
        errors: string[];
    };
    derived: { value: boolean; errors: string[] };
    single_per_period: { value: boolean | null; errors: string[] };
    periods_before_allowed: { value: number; errors: string[] };
    periods_after_allowed: { value: number; errors: string[] };
    device_field: { value: string; errors: string[] };
    location_field: { value: string; errors: string[] };
    possible_fields: { value: PossibleField[]; errors: string[] };
    label_keys: { value: string[]; errors: string[] };
    legend_threshold: { value: ScaleThreshold; errors: string[] };
};
